...
urlpatterns = [
    ...
    path('journals/osus/articles/BusinessFamiliesAndTheirRoleInTheEconomicDevelopmentOfSociety',views.business_families_and_their_role_in_the_economic_development_of_society,name='business_families_and_their_role_in_the_economic_development_of_society'),
    path('journals/osus/articles/GovernmentDigitalTransformationInYemen',views.government_digital_transformation_in_yemen,name='government_digital_transformation_in_yemen'),
    ...
    path('publications/journals/osus/Osus-(Vol.1)-04.pdf', views.download_or_view_fourth_ossus, name='download_or_view_fourth_ossus'),
    path('publications/journals/osus/Osus-(Vol.2)-05.pdf', views.download_or_view_fifth_ossus, name='download_or_view_fifth_ossus'),
    path('publications/journals/osus/Osus-(Vol.2)-06.pdf', views.download_or_view_sixth_ossus, name='download_or_view_sixth_ossus'),
    ...
    path('publications/Journals/Osus/osus-2025-12-fourth-issue-contents.pdf', views.view_osus_fourth_content, name='osus-fourth-content'),
    path('publications/Journals/Osus/fifth-osus-2026-4-issue-contents.pdf', views.view_osus_fifth_content, name='osus-fifth-content'),
    path('publications/Journals/Osus/sixth-osus-2026-8-issue-contents.pdf', views.view_osus_sixth_content, name='osus-sixth-content'),
