"""
Django settings for constit project.
...
SECRET_KEY = 'django-insecure-!cdxikri0bws2rrlsofw)#&*z%9fnb-kq445x6m@1#6yywb1ue'
...
MIDDLEWARE = [
    ...
    'pages.lowercase_redirect_middleware.InfographicsRedirectMiddleware',
...
WSGI_APPLICATION = 'constit.wsgi.application'
